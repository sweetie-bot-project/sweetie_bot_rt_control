...
void AnimJointTrajectory::newGoalHook(const Goal& pending_goal) 
{
	...
	try {
		goal_pending = std::make_shared<JointTrajectoryCache>(pending_goal, robot_model, threshold, algorithm); // TODO possible throw on malformed  goal: any better solutions?
	}
