...
class SolverIKNose : public SolverIKAnalytical
{
public:
	SolverIKNose(const KDL::Chain& chain, const KDL::JntArray& lower, const KDL::JntArray& upper, const KDL::Twist& tolerance) : 
...
bool SolverIKNose::is_registered = SolverIKFactoryAnalytical::Register(&SolverIKNose::createSolver);

std::unique_ptr<SolverIKAnalytical> SolverIKNose::createSolver(const KDL::Chain& chain, const KDL::JntArray& lower, const KDL::JntArray& upper, const KDL::Twist& tolerance, sweetie_bot::logger::Logger& log) 
{
	...
	return std::unique_ptr<SolverIKNose>(new SolverIKNose(chain, lower, upper, tolerance));
}

bool SolverIKNose::solveIK_impl(const KDL::Frame& b_T_e, KDL::JntArray& jnt, sweetie_bot::logger::Logger& log) const
{
