#ifndef OROCOS_SWEETIE_BOT_KINEMATICS_INV_ANALYTICAL_COMPONENT_HPP
#define OROCOS_SWEETIE_BOT_KINEMATICS_INV_ANALYTICAL_COMPONENT_HPP
...
class KinematicsInvAnalytical : public RTT::TaskContext
{
	protected:
	...
	protected:
		...
		// COMPONENT INTERFACE 
		// ports
		RTT::InputPort<sensor_msgs::JointState> in_joints_port_;
		...
		// COMPONENT STATE
		// buffers
		sensor_msgs::JointState joints_current_;
		sensor_msgs::JointState joints_result_;
	...
	public:
		KinematicsInvAnalytical(const std::string& name);
